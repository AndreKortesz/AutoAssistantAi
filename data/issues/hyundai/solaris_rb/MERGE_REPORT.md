# Отчёт о слиянии данных Solaris I (RB) — финальный
...
|-----------|------------|--------|
| `systemic_defect` | **25** | главные болячки, страница «Болячки» |
| `common_wear` | **28** | износ, страница «Здоровье авто» |
| `maintenance` | **20** | регламент ТО |
| `minor_annoyance` | **14** | мелочи, FAQ |
| `discarded_rare` | **22** | отброшено с обоснованием |
| **Итого активных записей** | **73** | + 22 отброшенных = **95 описанных болячек/износа/ТО** |
| Recalls (глобально) | 7 | Россия + США + Канада |
| Class actions (глобально) | 1 | Cho v. Hyundai (USA, dismissed) |
| TSB (глобально) | 2 | США (Hyundai 138+) |

Размер финального JSON: **812 KB**.
